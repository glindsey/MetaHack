...
std::string MapTileFancyAsciiView::getViewName()
{
  return "fancyASCII";
}

MapTileFancyAsciiView::MapTileFancyAsciiView(MapTile& map_tile,
...
UintVec2 MapTileFancyAsciiView::getFloorTileSheetCoords() const
{
...
UintVec2 MapTileFancyAsciiView::getSpaceTileSheetCoords() const
{
  /// @todo Deal with selecting one of the other tiles.
...
UintVec2 MapTileFancyAsciiView::getEntityTileSheetCoords(EntityId entity, int frame) const
{
  /// Get tile coordinates on the sheet.
  UintVec2 start_coords = m_views.getTileSheetCoords(COMPONENTS.category[entity]);
...
void MapTileFancyAsciiView::addTileVertices(EntityId viewer,
...
void MapTileFancyAsciiView::addMemoryVerticesTo(sf::VertexArray& vertices,
                                                EntityId viewer)
{
...
void MapTileFancyAsciiView::addHorizontalSurfaceVerticesTo(sf::VertexArray& vertices,
                                                           EntityId viewer,
                                                           Systems::Lighting& lighting)
{
  auto& config = S<IConfigSettings>();
...
void MapTileFancyAsciiView::addEntitiesVertices(EntityId viewer,
...
void MapTileFancyAsciiView::addEntityVertices(EntityId entityId,
                                              sf::VertexArray& vertices,
                                              Systems::Lighting* lighting,
                                              int frame)
{
...
void MapTileFancyAsciiView::addVerticalSurfaceVerticesTo(sf::VertexArray& vertices,
                                                         EntityId viewer,
                                                         Systems::Lighting* lighting)
{
  auto& tile = getMapTile();
...
bool MapTileFancyAsciiView::onEvent(Event const& event)
{
  return false;
}
