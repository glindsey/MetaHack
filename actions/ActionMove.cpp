...
namespace Actions
{
  ...
  StateResult ActionMove::doPreBeginWorkNVI(GameState& gameState, SystemManager& systems, json& arguments)
  {
    // All checks handled in Action by traits.
    return StateResult::Success();
  }

  StateResult ActionMove::doBeginWorkNVI(GameState& gameState, SystemManager& systems, json& arguments)
  {
    auto& components = gameState.components();
  ...
  StateResult ActionMove::doFinishWorkNVI(GameState& gameState, SystemManager& systems, json& arguments)
  {
    return StateResult::Success();
  }

  StateResult ActionMove::doAbortWorkNVI(GameState& gameState, SystemManager& systems, json& arguments)
  {
    return StateResult::Success();
  }
} // end namespace
