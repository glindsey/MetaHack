...
void MapNullView::update_tiles(EntityId viewer, Systems::Lighting& lighting)
{
}

void MapNullView::update_things(EntityId viewer, Systems::Lighting& lighting, int frame)
{
}
